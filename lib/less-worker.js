    ...
    if (err) {
        ...
        try {
            var css = tree.toCSS({
                ...
                writeSourceMap: this.getSourceMapWriter(destFileName),
...
LessWorker.prototype._sourceMapWriter = function (fileName, data) {
    // hmm
};

LessWorker.prototype.getSourceMapWriter = function (destFileName) {
    if (!this.options.sourceMapFileInline) {
        return this._sourceMapWriter.bind(this, destFileName);
    }
};
