...
**/
Master.prototype.getNextFile = function () {
...
@private
**/
Master.prototype._startWorkers = function (filesToProcess, filesToRead) {
...
**/
Master.prototype.startQueue = function (filesToProcess, filesToRead) {
    if (!this.running) {
...
**/
Master.prototype.buildFile = function (id, fileName) {
