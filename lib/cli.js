...
var shortHands = {
    ...
    'source-map-rootpath'   : ['--sourceMapRootpath'],
    'source-map-basepath'   : ['--sourceMapBasepath'],
    'source-map-map-inline' : ['--sourceMapFileInline'],
    'source-map-less-inline': ['--outputSourceFiles'],
...
var cli = module.exports = {
    ...
    parse: function (argv, slice) {
        ...
        return cli.clean(parsed, true);
    },
    clean: function (parsed, isClean) {
        if (!isClean) {
            // "parsed" is not the result of nopt(), needs cleaning
            nopt.clean(parsed, knownOpts);
        }
